...
// .wrangler/tmp/pages-zbUgle/functionsWorker-0.032756129235196885.mjs
...
async function onRequest(context) {
  ...
  const rawKey = format === "pdf" ? row.storage_path_pdf : row.storage_path_md;
  if (!rawKey) {
  ...
  const redirectTo = signedURL.startsWith("http") ? signedURL : `${SUPABASE_URL}${signedURL}`;
...
// .wrangler/tmp/bundle-3yAwgX/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-3yAwgX/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.032756129235196885.js.map
