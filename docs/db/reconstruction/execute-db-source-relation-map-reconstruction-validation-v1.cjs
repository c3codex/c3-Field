...
const files = {
  map: "docs/db/reconstruction/db_source_relation_map_reconstruction_passage_v1.md",
  validation:
    "docs/db/reconstruction/db_source_relation_map_reconstruction_validation_v1.sql",
  recovery:
    "docs/db/reconstruction/db_source_relation_map_reconstruction_recovery_posture_v1.md",
}
