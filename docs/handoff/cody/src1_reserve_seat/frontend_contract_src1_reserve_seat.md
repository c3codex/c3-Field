# Frontend Contract — SRC1 Reserve Seat

## Purpose

Wire Reserve Your Seat → SRC1 intake → RPC → success state.
...
`submit_src1_connect_request`

Do not insert directly into `src1_connect_request`.
...
Validation
 ...
 Row created in src1_connect_request
 env_key generated
