-- Seed Concordance Structural Expansion Validation v1
...
where version_key = 'seed_concordance_v1'
  and metadata ->> 'expansion' = 'seed_concordance_structural_expansion_seating_v1'
...
where version_key = 'seed_concordance_v1'
  and metadata ->> 'expansion' = 'seed_concordance_structural_expansion_seating_v1'
  and source_ref = 'seed_concordance_v1_slug'
  and metadata ->> 'relation_semantic' = 'authority_dissolved';
