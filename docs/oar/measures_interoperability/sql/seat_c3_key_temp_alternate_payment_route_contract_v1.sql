...
-- OAR2: docs/oar/measures_interoperability/oar2_temp_c3_key_alternate_payment_route_contract_v1.meta.md
--
-- OPERATOR: inspect live database standing before executing.
-- Run the inspection query below first. If c3_key_temp already exists, do not
-- execute this artifact without a separate reconciliation OAR2.
--
...
-- Email is contact, receipt, and recovery surface only. Email is not key
-- authority, recognition authority, conversion authority, wallet authority, or
-- NFT authority.
--
-- This artifact does not activate payment processing, mint NFTs, create
-- recognition standing, create conversion standing, or bind wallets.
