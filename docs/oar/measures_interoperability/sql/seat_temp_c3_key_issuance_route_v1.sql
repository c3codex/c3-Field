...
-- OAR2: docs/oar/measures_interoperability/oar2_temp_c3_key_issuance_route_v1.meta.md
--
-- Requires the live table seated by:
-- docs/oar/measures_interoperability/oar2_temp_c3_key_alternate_payment_route_contract_v1.meta.md
--
-- This artifact does not open public RLS policies, activate payment processing,
-- mint NFTs, bind wallets, create recognition, create conversion, or modify
