-- Source Reference Schema SQL Draft v1 - Preflight Corrected
-- Preflight standing: db_preflight_passed, not executed
...
-- Validation block, not part of migration execution:
--
-- Source standing:
