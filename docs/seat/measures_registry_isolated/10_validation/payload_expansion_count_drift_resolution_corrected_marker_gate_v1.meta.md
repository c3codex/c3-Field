...
title: Payload Expansion Count Drift Resolution - Corrected Marker Gate v1
status: resolved
version: v1
...
# Payload Expansion Count Drift Resolution - Corrected Marker Gate v1
...
trace_result:
  ...
  extra_row_classification:
    ...
    allowed:
      ...
      - duplicate
      - hold
  explanation: later-created manifest-resolution copy duplicates the earlier addendum record key and authority
...
resolution_effect:
  ...
  applied_result: duplicate_sources_merged_into_canonical_record
