...
test("H: generated secret canaries never appear in public results or ordinary logs",async()=>{
 ...
 const runtime={...env,SUPABASE_SERVICE_ROLE_KEY:secretValues[0],C3_RESEND_API_KEY:secretValues[1],C1_VERIFICATION_SIGNING_KEY:secretValues[2]}
...
const env: PassageEnv={SUPABASE_URL:"https://zfihrspxvennjzazxcbj.supabase.co",SUPABASE_SERVICE_ROLE_KEY:"server-secret",C3_RESEND_API_KEY:"transport-secret",C1_VERIFICATION_FROM:"c3 <connect@example.invalid>",C1_PUBLIC_ORIGIN:"https://example.invalid",C1_VERIFICATION_SIGNING_KEY:"s".repeat(48),C1_PASSAGE_ENABLED:"true"}
...
for(const missing of ["C3_RESEND_API_KEY","C1_VERIFICATION_FROM","C1_VERIFICATION_SIGNING_KEY","C1_PUBLIC_ORIGIN","SUPABASE_SERVICE_ROLE_KEY","C1_PASSAGE_ENABLED"]){
