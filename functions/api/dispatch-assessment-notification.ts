import { deliverAssessmentResultEmail, type AssessmentDeliveryEnv } from "./assessment-delivery-service"
...
export const onRequestPost = async ({ request, env }: { request: Request, env: Env }) => {
  try {
    ...
    const result = await deliverAssessmentResultEmail(env, captureId ?? "")
