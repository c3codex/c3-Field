---
title: Measures Installation Logic Map
...
summary: Defines the installation behavior for the Measures pillar. Maps encounter types, navigation resolution, media fallback rules, and access-state behavior so that database, renderer, and governance logic align.
---
