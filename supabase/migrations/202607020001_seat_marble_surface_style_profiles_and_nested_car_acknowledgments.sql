...
--
-- Changes:
-- STEP 1: Media rows for 3 marble surface backgrounds
-- STEP 2: Register marble_chamber_results surface (registry + encounter_def + surface_assignment)
-- STEP 3: Seat style profiles on 5 marble surface assignments
-- STEP 4: Seat c3_7_acknowledgment content in map_integrity_governance encounter_def
-- STEP 5: Seat center_panel content in map_integrity_governance encounter_def
-- STEP 6: Update marble_chamber_orientation content_profile (ASSESSMENT COMPLETE copy)
-- STEP 7: Update marble_chamber_results content_profile
-- STEP 8: Update encounter flow transitions
--
-- DOES NOT TOUCH: scoring, pricing, Stripe, assessment questions, SEAT/c3Key/DAO activation,
-- certification language, concordance, report copy.
...
-- ============================================================
-- STEP 4: Seat c3_7_acknowledgment and center_panel content
--         in map_integrity_governance encounter_def
-- ============================================================
...
--         (ASSESSMENT COMPLETE copy; route to marble_chamber_results)
-- ============================================================
...
--         (CTA label override for results → MAP)
-- ============================================================
...
--         marble_chamber_encounter → legacy_alias_for_marble_chamber_results
-- ============================================================

-- Update marble_chamber_orientation node: next_surface = marble_chamber_results
...
-- Add marble_chamber_results node: next_surface = marble_chamber_C2_compact
UPDATE public.measures_registry
SET metadata = jsonb_set(
  metadata,
...
-- Mark marble_chamber_encounter as legacy alias (was next_surface = marble_chamber_C2_compact)
UPDATE public.measures_registry
SET metadata = jsonb_set(
  metadata,
...
-- Mark /map-integrity-governance route context in encounter_structure
UPDATE public.measures_registry
SET metadata = jsonb_set(
  metadata,
...
BEGIN
  ...
  -- Verify c3_7_acknowledgment seated with 7 units
  ...
  -- Verify marble_chamber_results registered
  ...
  -- Verify flow transition updated
