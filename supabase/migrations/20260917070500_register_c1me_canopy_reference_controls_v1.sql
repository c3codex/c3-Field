...
insert into public.system_process_registry (
  ...
  'c1me_canopy_reference_controls_v1','c3_field','c1ME Canopy Reference Controls v1','active','docs/oar/c3_field/oar2_implement_c1me_canopy_reference_controls_v1.meta.md','operator_confirmed_bounded_control_surface',
  jsonb_build_object(
    'operator','op044','standing','authorized_for_bounded_implementation','execution_instance_id','implement_c1me_canopy_reference_controls_chazz_005','mgs_key','c1me_minimum_governed_standard_v0_1','mgs_evaluation','c1me_stephanie_mgs_evaluation_v0_1','target_class','c1ME.env','authorized_controls',jsonb_build_array('add','edit','remove','open','copy_c3_link'),'canopy_reference_rule','owner-controlled EnvPac reference/Selection; no Registry standing','canopy_semantic_seam','Canopy Reference is not Canopy carrier authority','existing_canopy_law','c3_field_canopy_law_base','open_rule','owner browser/device navigates to stored owner-supplied URL; c3 server does not fetch external destination','allowed_url_schemes',jsonb_build_array('https','http','mailto'),'external_provider_access','none','oauth_authority',false,'registry_standing_created_for_reference',false,'c2_c3_authority_created',false,'runtime_preflight_required',true,'owner_authority_source','active EnvPac owner grant + current session + satisfied current c1ME MGS binding/evaluation','active_hold_conditions',jsonb_build_array(jsonb_build_object('condition_key','owner_session_or_grant_invalid','result','HOLD'),jsonb_build_object('condition_key','mgs_binding_or_evaluation_not_current','result','HOLD'),jsonb_build_object('condition_key','c1_scope_changed','result','HOLD'),jsonb_build_object('condition_key','higher_order_capability_active','result','HOLD'),jsonb_build_object('condition_key','external_provider_access_attempted','result','HOLD')),'next_permitted_transition','implement_then_oar1_closeout'
  ),
  'c1ME Canopy Reference Controls v1','owner-controlled Canopy Reference Add/Edit/Remove/Open and public c3-link copy within satisfied c1ME scope','active','bounded_runtime_control',jsonb_build_array('governance:c1me_canopy_reference_boundary_rule_v1','mgs:c1me_minimum_governed_standard_v0_1','evaluation:c1me_stephanie_mgs_evaluation_v0_1','canopy_law:c3_field_canopy_law_base','oar2:implement_c1me_canopy_reference_controls_chazz_005'),'oar2',false,true,true,now(),now()
)
...
insert into public.measures_persistence_state (
  ...
  'c1me_canopy_reference_controls_v1:implementation_authority:env_person_eea672f5a7676dad4316755b','c1me_canopy_reference_controls_v1','implement_c1me_canopy_reference_controls_chazz_005','env_person_eea672f5a7676dad4316755b','c1me_canopy_reference_controls_v1_env_person_eea672f5a7676dad4316755b','bounded_implementation_authority',
  jsonb_build_object('process_key','c1me_canopy_reference_controls_v1','target_env_key','env_person_eea672f5a7676dad4316755b','target_envpac_key','c3envpac_person_eea672f5a7676dad4316755b_v0_1','subject_key','crs_93e901234ae044a396654ee80644b005','mgs_evaluation','c1me_stephanie_mgs_evaluation_v0_1','mgs_result','minimum_governed_standard_satisfied','authorized_controls',jsonb_build_array('add','edit','remove','open','copy_c3_link'),'reference_storage_class','envpac_operational_selection','reference_registry_standing_created',false,'canopy_carrier_authority_created',false,'external_provider_access_created',false,'oauth_authority_created',false,'external_write_authority_created',false,'c2_standing_created',false,'c3_standing_created',false,'runtime_release_authorized',true,'source_superseded',false),
  jsonb_build_object('operator','op044','operator_instruction','proceed','execution_instance_id','implement_c1me_canopy_reference_controls_chazz_005','oar2_governance_path','github-private://c3codex/measures-of-inanna-governance/main/docs/oar/c3_field/oar2_implement_c1me_canopy_reference_controls_v1.meta.md','oar2_governance_commit','8426c27d041b4665037273328c17d310fe3ec654','oar2_governance_blob_sha1','abcb20aa8a05dfe34c0cbb15a10cd9c1ad2b10b7','mgs_evaluation_persistence','c1me_mgs_evaluation:env_person_eea672f5a7676dad4316755b:v0_1','canopy_boundary_rule','c1me_canopy_reference_boundary_rule_v1','source_concordance_control','current_source_concordance_v16'),
  jsonb_build_object('computational_custody','Measures Codex Registry','reference_data_custody','c3_field EnvPac operational store under owner control','external_destination_custody','external provider / owner; not c3','ownership_transfer',false,'custody_transfer',false,'public_release',false),
  jsonb_build_object('append_preserving',true,'mgs_evaluation','c1me_mgs_evaluation:env_person_eea672f5a7676dad4316755b:v0_1','mgs_binding','c1me_mgs_binding:env_person_eea672f5a7676dad4316755b:v0_1','boundary_rule','c1me_canopy_reference_boundary_rule_v1','existing_canopy_law','c3_field_canopy_law_base','source_superseded',false),
  'authorized_for_bounded_implementation','implement_c1me_canopy_reference_controls_v1','registrar',now(),now()
)
