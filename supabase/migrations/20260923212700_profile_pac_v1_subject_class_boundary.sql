-- ProfilePAC subject/profile-class compatibility boundary.
-- A registered individual subject cannot be relabeled as a non-individual ProfilePAC by client input.
...
begin
  ...
  ) then raise exception 'profile_contract_unavailable'; end if;
  ...
  insert into public.c3_pac (
    ...
    'c3://profile-pac/'||v_profile_key||'/v1','pac_base_contract_v1',true,
    jsonb_build_object('formation_oar','oar2_admit_pac_v1_and_wire_oye_profilepac_chazz_001_20260923',
      'profile_does_not_create_authority',true,'subject_values_explicitly_submitted',true),
